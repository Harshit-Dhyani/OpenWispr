...
```typescript
// app/desktop/shared/types/settings.ts
...
```typescript
// app/desktop/shared/config/presets.ts
...
```typescript
// app/desktop/frontend/src/components/settings/
...
```typescript
// app/desktop/main/hotkey/GlobalHotkeyManager.ts
...
```typescript
// app/desktop/floating/FloatingTranscriptionWindow.tsx
...
```typescript
// app/desktop/floating/PushToTalkController.ts
