...
class DownloadRootSettingsTests(unittest.TestCase):
    def test_default_download_root_uses_windows_appdata(self) -> None:
        with patch('app.core.settings.config.sys.platform', 'win32'), patch.dict(os.environ, {'APPDATA': r'C:\Users\tester\AppData\Roaming'}, clear=False):
    ...
    def test_legacy_env_download_root_is_upgraded(self) -> None:
        with patch('app.core.settings.config.sys.platform', 'win32'), patch.dict(os.environ, {'APPDATA': r'C:\Users\tester\AppData\Roaming', 'TRANSCRIPTA_DOWNLOAD_ROOT': './models'}, clear=False):
            expected = Path(r'C:\Users\tester\AppData\Roaming') / AppConstants.APP_NAME / 'models'
    ...
    def test_custom_download_root_is_preserved(self) -> None:
        with patch('app.core.settings.config.sys.platform', 'win32'), patch.dict(os.environ, {'APPDATA': r'C:\Users\tester\AppData\Roaming', 'TRANSCRIPTA_DOWNLOAD_ROOT': r'D:\Custom\Models'}, clear=False):
