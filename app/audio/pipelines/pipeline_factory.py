...
from app.audio.pipelines.system_pipeline import SystemPipeline, SystemPipelineConfig
from app.audio.pipelines.wispr_pipeline import WisprPipeline, WisprPipelineConfig
