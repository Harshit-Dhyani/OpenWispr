...
class SystemProfiler:
    ...
    def _profile_gpu(self) -> GPUProfile:
        ...
        try:
            ...
            logger.warning("GPU profiling failed, assuming no GPU available: %s", e)
            return GPUProfile(
                available=False,
                name="No GPU",
                vram_gb=0.0,
    ...
    def _profile_cpu(self) -> CPUProfile:
        ...
        try:
            ...
            logger.warning("CPU AVX2 detection failed: %s", e)
    ...
    def _profile_storage(self) -> StorageProfile:
        ...
        try:
            ...
            logger.warning("Storage SSD detection failed: %s", e)
    ...
    def _cpu_count(*, logical: bool) -> int:
        ...
        try:
            ...
            logger.warning("CPU count detection failed: %s", e)
            return 0
    ...
    def _virtual_memory_total() -> int:
        ...
        try:
            ...
            logger.warning("Virtual memory detection failed: %s", e)
    ...
    def _disk_usage(path: Path) -> tuple[int, int]:
        ...
        try:
            ...
            logger.warning("Disk usage detection failed: %s", e)
            fallback = 100 * 1024**3
