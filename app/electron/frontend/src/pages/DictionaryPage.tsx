    ...
    <FeaturePageShell
      ...
      summary={
        <div className="flex flex-col gap-3">
          ...
          <div className="grid gap-2 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1.1fr)_auto]">
            <input
              value={search}
            ...
            />
            <div className="text-xs font-bold text-lawn-muted lg:self-center">
              Deterministic phrase replacement runs before paste/copy so transcript cleanup stays stable.
            </div>
            <button
              type="button"
              onClick={() => void load()}
      ...
      <div className="grid h-full min-h-0 gap-2 xl:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
        ...
        <section className="min-h-0 overflow-hidden border-2 border-lawn-border bg-lawn-panel shadow-brutal-sm">
          <div className="flex items-center justify-between border-b-2 border-lawn-border bg-lawn-bg p-2">
            <div>
              <h3 className="text-[10px] font-black uppercase tracking-[0.14em] text-lawn-muted">Current dictionary</h3>
              <p className="mt-0.5 text-xs font-bold text-lawn-muted">{entries.length} active phrase replacement{entries.length === 1 ? '' : 's'}</p>
            </div>
          </div>
