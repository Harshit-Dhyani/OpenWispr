        ...
        <section className="min-h-0 overflow-hidden border-2 border-lawn-border bg-lawn-panel shadow-brutal-sm">
          <div className="flex items-center justify-between border-b-2 border-lawn-border bg-lawn-bg p-3">
            <div>
              ...
              <p className="mt-1 text-xs font-bold text-lawn-muted">{entries.length} active phrase replacement{entries.length === 1 ? '' : 's'}</p>
            </div>
          </div>
              ...
              {entries.map((entry) => (
                <article key={entry.id} className="flex min-w-0 items-center justify-between gap-2 border-2 border-lawn-border bg-lawn-bg p-2">
                  <div className="min-w-0 flex-1">
                    <p className="text-sm font-black text-lawn-border break-all">{entry.phrase} → {entry.replacement}</p>
