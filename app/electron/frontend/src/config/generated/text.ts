...
export const SETTING_DESCRIPTIONS = {
  ...
  "default_capture_source": "Choose which source OpenWispr should preselect for the next session",
...
export const SETTINGS_SECTION_TEXT = {
  "audio": {
    ...
    "default_capture_source_description": "Choose which source OpenWispr should preselect. You can still switch it instantly from the main screen.",
    ...
    "audio_backend_description": "Choose which Windows capture backend OpenWispr should prefer",
    ...
    "mute_during_dictation_description": "Silence OpenWispr window audio while microphone dictation is active",
